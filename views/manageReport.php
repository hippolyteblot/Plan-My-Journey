                ...
                ?>
                    <div class="commentary glass">
                        ...
                        <div class="actions">
                            ...
                            <form method="post">
                                <input type="hidden" name="commentaryId" value="<?= $commentary['commentary_id'] ?>">
                                <button type="submit" name="banAccount" class="journey-button" title="Bannir l'utilisateur"><span class="material-symbols-outlined">block</span></button>
                                <input type="hidden" name="userId" value="<?= $commentary['user_id'] ?>">
                            </form>
